 ...
 */
public class TagLayout2 extends LinearLayout {
    ...
    public void addTagView(TagView2 tag) {
...
//            params.gravity = Gravity.RIGHT;
    ...
    private boolean allowAddToThisRow(TagView2 v) {

        int sumWith = v.getTagWidth();

        for (int i = 0; i < mRow.getChildCount(); i++) {
            sumWith += ((TagView2) mRow.getChildAt(i)).getTagWidth();
        }
